...
AUDIO_OUT  = os.path.join(PROJECT, 'assets', 'audio', 'LLNL_Speech_andrew.mp3')
...
concat_video = os.path.join(PROJECT, 'build', 'ffmpeg_concat.txt')
os.makedirs(os.path.dirname(concat_video), exist_ok=True)
